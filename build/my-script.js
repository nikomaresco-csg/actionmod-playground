...
(() => {
  ...
  // src/utils/data.ts
  var { TextDataReaderSettings, TextFileDataSource } = Spotfire.Dxp.Data.Import;
  var { DataType } = Spotfire.Dxp.Data;
  var { MemoryStream, StreamWriter, SeekOrigin } = System.IO;
  ...
  function createDataSourceFromCsv(csv, delimiter = ",", hasHeaderRow = true, hasTypeRow = false) {
  ...
  var { AddCalculatedColumnTransformation } = Spotfire.Dxp.Data.Transformations;
  var {
    DataColumnSignature,
    AddColumnsSettings,
    JoinType,
  ...
  var { MemoryStream: MemoryStream2, StreamWriter: StreamWriter2, SeekOrigin: SeekOrigin2 } = System.IO;
  ...
  function generateSquareWKT(lowerLeftX, lowerLeftY, sideLength) {
